  ...
  if (bureau.ghosts.length === 0) {
    return (
      <EmptyState
        ...
        description="Заявки от привидений ещё не поступали. Загрузите демонстрационный набор — восемь заявок и шесть мест, на которых видно все режимы работы бюро: обычный подбор, конкуренцию за место, просроченный срок и случай, когда переселение невозможно."
        action={
